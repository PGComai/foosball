...
export(int, 'scroll', 'mouse') var spin_mode
...
onready var spinner1 = $spinners/team1/ax1/RigidBody
onready var spinner1h = $spinners/team1/ax1/RigidBody/rod/highlight
onready var spinner2 = $spinners/team1/ax2/RigidBody
onready var spinner2h = $spinners/team1/ax2/RigidBody/rod/highlight
onready var spinner3 = $spinners/team1/ax4/RigidBody
onready var spinner3h = $spinners/team1/ax4/RigidBody/rod/highlight
onready var spinner4 = $spinners/team1/ax6/RigidBody
onready var spinner4h = $spinners/team1/ax6/RigidBody/rod/highlight
...
func _physics_process(delta):
	pushpull = lerp(pushpull, 0, 0.2)
	mousespin = lerp(mousespin, 0, 0.2)
	spin_strength = lerp(spin_strength, 0, 0.1)
